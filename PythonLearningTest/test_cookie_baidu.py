...
if __name__ == '__main__':
    #登陆地址
    login_url = 'http://www.cnblogs.com/wp-admin/admin-ajax.php'
    #User-Agent信息
    ...
    Login_Data['redirect_url'] = 'http://www.cnblogs.com/'
    Login_Data['remember_me'] = '0' #是否一个月内自动登陆
    Login_Data['user_login'] = '2099557384@qq.com' #改成你自己的用户名
    Login_Data['user_pass'] = '090126my' #改成你自己的密码
    #使用urlencode方法转换标准格式
    ...
    #面向对象地址
    date_url = 'http://date.cnblogs.com/wp-admin/admin-ajax.php'
    #面向对象
    Date_Data = {}
